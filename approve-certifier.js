...
async function run() {
  ...
  // Click to approve
  const approveFirstButton = removeAngular('#mat-tab-content-0-0 > div > div > app-admin-users-table > mat-table > mat-row:nth-child(2) > mat-cell.mat-cell.cdk-cell.cell-220.text-center.cdk-column-validation_actions.mat-column-validation_actions.ng-star-inserted > button:nth-child(1)');
